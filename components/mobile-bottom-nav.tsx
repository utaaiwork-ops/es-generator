...
export function MobileBottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 flex h-16 items-center justify-around border-t border-border bg-card/80 backdrop-blur-lg pb-[env(safe-area-inset-bottom)] md:hidden">
      {navItems.map((item) => {
